...
export const PricingSection = (props: Props) => {
    return (
        <div
            className="w-full mt-20 flex flex-col items-center gap-3"
            id="pricing"
        >
            <BackdropGradient className="w-8/12 h-full opacity-40 flex flex-col items-center">
                <GradientText
                    ...
                    element="H2"
                >
                    Pricing Plans That fits Your Right
                </GradientText>
                <p className="text-sm md:text-center text-left text-muted-foreground">
                    Grouple is a vibrant online community platform that empowers
                    people to connect,
                    <br className="hidden md:block" /> collaborate, and
                    cultivate meaningfully relationships
                </p>
            </BackdropGradient>
            <Card className="p-7 mt-10 md:w-auto w-full bg-themeBlack  border-themeGray">
                <div className="flex flex-col gap-2">
                    ...
                    <CardDescription className="text-[#B4B0AE]">
                        Greate if you are just getting started
                    </CardDescription>
