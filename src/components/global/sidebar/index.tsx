        ...
        >
            {groups.groups && groups.groups.length > 0 &&(
                ...
                trigger={
                    ...
                    text-themeGray md:border-[1px] border-themeGray p-3 rounded-xl
                    ">
                ...
                >
                    {groupid && 
                    groups.groups.length > 0 && groups.groups.map((item) =>
                        <Link key={item.id} 
            ...
            <div className="flex flex-col gap-y-5">
                <div className="flex justify-between items-center">
                    <p className="text-xs text-[#F7ECE9]">
                        CHANNELS
                    </p>
                    {groupid === groupInfo.group?.userId && (
                        <Plus
                        size={16}
                        className={cn(
